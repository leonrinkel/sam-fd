...
#define SERCOM0_BASE_ADDR 0x42000400u
/** \brief SERCOM1 registers base address */
#define SERCOM1_BASE_ADDR 0x42000800u
/** \brief SERCOM2 registers base address */
#define SERCOM2_BASE_ADDR 0x42000C00u
/** \brief SERCOM3 registers base address */
#define SERCOM3_BASE_ADDR 0x42001000u
/** \brief SERCOM4 registers base address */
#define SERCOM4_BASE_ADDR 0x42001400u
/** \brief SERCOM5 registers base address */
#define SERCOM5_BASE_ADDR 0x42001800u
...
#define SERCOM0_CTRLA_ADDR (SERCOM0_BASE_ADDR + SERCOM_CTRLA_OFF)
/** \brief SERCOM1 CTRLA register address */
#define SERCOM1_CTRLA_ADDR (SERCOM1_BASE_ADDR + SERCOM_CTRLA_OFF)
/** \brief SERCOM2 CTRLA register address */
#define SERCOM2_CTRLA_ADDR (SERCOM2_BASE_ADDR + SERCOM_CTRLA_OFF)
/** \brief SERCOM3 CTRLA register address */
#define SERCOM3_CTRLA_ADDR (SERCOM3_BASE_ADDR + SERCOM_CTRLA_OFF)
/** \brief SERCOM4 CTRLA register address */
#define SERCOM4_CTRLA_ADDR (SERCOM4_BASE_ADDR + SERCOM_CTRLA_OFF)
/** \brief SERCOM5 CTRLA register address */
#define SERCOM5_CTRLA_ADDR (SERCOM5_BASE_ADDR + SERCOM_CTRLA_OFF)
...
#define SERCOM0_CTRLB_ADDR (SERCOM0_BASE_ADDR + SERCOM_CTRLB_OFF)
/** \brief SERCOM1 CTRLB register address */
#define SERCOM1_CTRLB_ADDR (SERCOM1_BASE_ADDR + SERCOM_CTRLB_OFF)
/** \brief SERCOM2 CTRLB register address */
#define SERCOM2_CTRLB_ADDR (SERCOM2_BASE_ADDR + SERCOM_CTRLB_OFF)
/** \brief SERCOM3 CTRLB register address */
#define SERCOM3_CTRLB_ADDR (SERCOM3_BASE_ADDR + SERCOM_CTRLB_OFF)
/** \brief SERCOM4 CTRLB register address */
#define SERCOM4_CTRLB_ADDR (SERCOM4_BASE_ADDR + SERCOM_CTRLB_OFF)
/** \brief SERCOM5 CTRLB register address */
#define SERCOM5_CTRLB_ADDR (SERCOM5_BASE_ADDR + SERCOM_CTRLB_OFF)
...
#define SERCOM0_BAUD_ADDR (SERCOM0_BASE_ADDR + SERCOM_BAUD_OFF)
/** \brief SERCOM1 BAUD register address */
#define SERCOM1_BAUD_ADDR (SERCOM1_BASE_ADDR + SERCOM_BAUD_OFF)
/** \brief SERCOM2 BAUD register address */
#define SERCOM2_BAUD_ADDR (SERCOM2_BASE_ADDR + SERCOM_BAUD_OFF)
/** \brief SERCOM3 BAUD register address */
#define SERCOM3_BAUD_ADDR (SERCOM3_BASE_ADDR + SERCOM_BAUD_OFF)
/** \brief SERCOM4 BAUD register address */
#define SERCOM4_BAUD_ADDR (SERCOM4_BASE_ADDR + SERCOM_BAUD_OFF)
/** \brief SERCOM5 BAUD register address */
#define SERCOM5_BAUD_ADDR (SERCOM5_BASE_ADDR + SERCOM_BAUD_OFF)
...
#define SERCOM0_INTENSET_ADDR (SERCOM0_BASE_ADDR + SERCOM_INTENSET_OFF)
/** \brief SERCOM1 INTENSET register address */
#define SERCOM1_INTENSET_ADDR (SERCOM1_BASE_ADDR + SERCOM_INTENSET_OFF)
/** \brief SERCOM2 INTENSET register address */
#define SERCOM2_INTENSET_ADDR (SERCOM2_BASE_ADDR + SERCOM_INTENSET_OFF)
/** \brief SERCOM3 INTENSET register address */
#define SERCOM3_INTENSET_ADDR (SERCOM3_BASE_ADDR + SERCOM_INTENSET_OFF)
/** \brief SERCOM4 INTENSET register address */
#define SERCOM4_INTENSET_ADDR (SERCOM4_BASE_ADDR + SERCOM_INTENSET_OFF)
/** \brief SERCOM5 INTENSET register address */
#define SERCOM5_INTENSET_ADDR (SERCOM5_BASE_ADDR + SERCOM_INTENSET_OFF)
...
#define SERCOM0_INTFLAG_ADDR (SERCOM0_BASE_ADDR + SERCOM_INTFLAG_OFF)
/** \brief SERCOM1 INTFLAG register address */
#define SERCOM1_INTFLAG_ADDR (SERCOM1_BASE_ADDR + SERCOM_INTFLAG_OFF)
/** \brief SERCOM2 INTFLAG register address */
#define SERCOM2_INTFLAG_ADDR (SERCOM2_BASE_ADDR + SERCOM_INTFLAG_OFF)
/** \brief SERCOM3 INTFLAG register address */
#define SERCOM3_INTFLAG_ADDR (SERCOM3_BASE_ADDR + SERCOM_INTFLAG_OFF)
/** \brief SERCOM4 INTFLAG register address */
#define SERCOM4_INTFLAG_ADDR (SERCOM4_BASE_ADDR + SERCOM_INTFLAG_OFF)
/** \brief SERCOM5 INTFLAG register address */
#define SERCOM5_INTFLAG_ADDR (SERCOM5_BASE_ADDR + SERCOM_INTFLAG_OFF)
...
#define SERCOM0_STATUS_ADDR (SERCOM0_BASE_ADDR + SERCOM_STATUS_OFF)
/** \brief SERCOM1 STATUS register address */
#define SERCOM1_STATUS_ADDR (SERCOM1_BASE_ADDR + SERCOM_STATUS_OFF)
/** \brief SERCOM2 STATUS register address */
#define SERCOM2_STATUS_ADDR (SERCOM2_BASE_ADDR + SERCOM_STATUS_OFF)
/** \brief SERCOM3 STATUS register address */
#define SERCOM3_STATUS_ADDR (SERCOM3_BASE_ADDR + SERCOM_STATUS_OFF)
/** \brief SERCOM4 STATUS register address */
#define SERCOM4_STATUS_ADDR (SERCOM4_BASE_ADDR + SERCOM_STATUS_OFF)
/** \brief SERCOM5 STATUS register address */
#define SERCOM5_STATUS_ADDR (SERCOM5_BASE_ADDR + SERCOM_STATUS_OFF)
...
#define SERCOM0_SYNCBUSY_ADDR (SERCOM0_BASE_ADDR + SERCOM_SYNCBUSY_OFF)
/** \brief SERCOM1 SYNCBUSY register address */
#define SERCOM1_SYNCBUSY_ADDR (SERCOM1_BASE_ADDR + SERCOM_SYNCBUSY_OFF)
/** \brief SERCOM2 SYNCBUSY register address */
#define SERCOM2_SYNCBUSY_ADDR (SERCOM2_BASE_ADDR + SERCOM_SYNCBUSY_OFF)
/** \brief SERCOM3 SYNCBUSY register address */
#define SERCOM3_SYNCBUSY_ADDR (SERCOM3_BASE_ADDR + SERCOM_SYNCBUSY_OFF)
/** \brief SERCOM4 SYNCBUSY register address */
#define SERCOM4_SYNCBUSY_ADDR (SERCOM4_BASE_ADDR + SERCOM_SYNCBUSY_OFF)
/** \brief SERCOM5 SYNCBUSY register address */
#define SERCOM5_SYNCBUSY_ADDR (SERCOM5_BASE_ADDR + SERCOM_SYNCBUSY_OFF)
...
#define SERCOM0_DATA_ADDR (SERCOM0_BASE_ADDR + SERCOM_DATA_OFF)
/** \brief SERCOM1 DATA register address */
#define SERCOM1_DATA_ADDR (SERCOM1_BASE_ADDR + SERCOM_DATA_OFF)
/** \brief SERCOM2 DATA register address */
#define SERCOM2_DATA_ADDR (SERCOM2_BASE_ADDR + SERCOM_DATA_OFF)
/** \brief SERCOM3 DATA register address */
#define SERCOM3_DATA_ADDR (SERCOM3_BASE_ADDR + SERCOM_DATA_OFF)
/** \brief SERCOM4 DATA register address */
#define SERCOM4_DATA_ADDR (SERCOM4_BASE_ADDR + SERCOM_DATA_OFF)
/** \brief SERCOM5 DATA register address */
#define SERCOM5_DATA_ADDR (SERCOM5_BASE_ADDR + SERCOM_DATA_OFF)
